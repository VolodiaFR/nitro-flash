...
import { RoomContextVariablesMessageEvent } from './messages/incoming/room/variables/RoomContextVariablesMessageEvent';
import { RoomInternalContextVariablesMessageEvent } from './messages/incoming/room/variables/RoomInternalContextVariablesMessageEvent';
...
import { FurniFixToolSaveMessageComposer } from './messages/outgoing/room/engine/FurniFixToolSaveMessageComposer';
import { IsOnFurniFixMessageComposer } from './messages/outgoing/room/engine/IsOnFurniFixMessageComposer';
import { RequestFurniWithVariablesComposer } from './messages/outgoing/room/variables/RequestFurniWithVariablesComposer';
import { RequestRoomVariablesComposer } from './messages/outgoing/room/variables/RequestRoomVariablesComposer';
import { RequestUserVariablesComposer } from './messages/outgoing/room/variables/RequestUserVariablesComposer';
import { RequestUserWithVariablesComposer } from './messages/outgoing/room/variables/RequestUserWithVariablesComposer';
import { ToggleHighlightModeComposer } from './messages/outgoing/room/variables/ToggleHighlightModeComposer';
import { ToggleFurniInspectionLockComposer } from './messages/outgoing/room/variables/ToggleFurniInspectionLockComposer';
import { ToggleGlobalInspectionComposer } from './messages/outgoing/room/variables/ToggleGlobalInspectionComposer';
import { InspectUserVariablesComposer } from './messages/outgoing/room/variables/InspectUserVariablesComposer';
...
export class NitroMessages implements IMessageConfiguration {
    ...
    private registerEvents(): void {
        // CUSTOM
        this._events.set(IncomingHeader.ABOUT_ALERT, AboutAlertEvent);
        this._events.set(IncomingHeader.GET_FURNIFIXTOOL_FURNI_DATA, GetFurniFixToolFurniDataEvent);
        this._events.set(IncomingHeader.USER_ON_CLICKTHROUGH, PlayerOnClickThroughEvent);
        this._events.set(IncomingHeader.USER_WALKKEYS, PlayerWalkKeysEvent);
        this._events.set(IncomingHeader.USER_VIMKEYS, PlayerVimKeysEvent);
        this._events.set(IncomingHeader.ROOM_SPOTLIGHT_OVERLAY, RoomSpotlightOverlayEvent);
        // Room variable system
        this._events.set(IncomingHeader.ROOM_FURNI_VARIABLES, RoomFurniVariablesMessageEvent);
        this._events.set(IncomingHeader.ROOM_INTERNAL_FURNI_VARIABLES, RoomInternalFurniVariablesMessageEvent);
        this._events.set(IncomingHeader.ROOM_USER_VARIABLES, RoomUserVariablesMessageEvent);
        this._events.set(IncomingHeader.ROOM_INTERNAL_USER_VARIABLES, RoomInternalUserVariablesMessageEvent);
        this._events.set(IncomingHeader.ROOM_GLOBAL_VARIABLES, RoomGlobalVariablesMessageEvent);
        this._events.set(IncomingHeader.ROOM_INTERNAL_GLOBAL_VARIABLES, RoomInternalGlobalVariablesMessageEvent);
        this._events.set(IncomingHeader.ROOM_CONTEXT_VARIABLES, RoomContextVariablesMessageEvent);
        this._events.set(IncomingHeader.ROOM_INTERNAL_CONTEXT_VARIABLES, RoomInternalContextVariablesMessageEvent);
        this._events.set(IncomingHeader.FURNI_WITH_VARIABLES, FurniWithVariablesMessageEvent);
        this._events.set(IncomingHeader.USER_WITH_VARIABLES, UserWithVariablesMessageEvent);
        ...
        this._events.set(IncomingHeader.BLACKJACK_BET_PROMPT, BlackjackBetPromptMessageEvent);
        // ADVERTISEMENT
        ...
        this._events.set(IncomingHeader.FRAME_INVENTORY, FrameInventoryEvent);
        ...
        this._events.set(IncomingHeader.BULK_ROLLING, BulkObjectsRollingEvent);
        ...
        this._events.set(IncomingHeader.BULK_UPDATE_FLOOR_ITEMS, BulkUpdateFloorItemsEvent);
        ...
        this._events.set(IncomingHeader.BULK_HEIGHT_MAP_UPDATE, BulkHeightMapUpdateEvent);
        ...
        this._events.set(IncomingHeader.USER_FOCUS_STATUS, RoomUnitFocusEvent);
        ...
        this._events.set(IncomingHeader.WIRED_CLIPBOARD_STATUS, WiredClipboardStatusMessageEvent);
        ...
        // CUSTOM FURNIFIX
        this._events.set(IncomingHeader.FURNIFIXTOOL_BATCH_SAVE_RESPONSE, FurniFixToolBatchSaveResponseEvent);
    }

    private registerComposers(): void {

        //CUSTOM WIRED KEYBOARDINPUT
        this._composers.set(OutgoingHeader.KEYBOARD_INPUT, KeyboardInputMessageComposer);
        this._composers.set(OutgoingHeader.BLACKJACK_BET, BlackjackBetMessageComposer);
        this._composers.set(OutgoingHeader.BLACKJACK_HIT, BlackjackHitMessageComposer);
        this._composers.set(OutgoingHeader.BLACKJACK_STAND, BlackjackStandMessageComposer);
        this._composers.set(OutgoingHeader.BLACKJACK_JOIN_QUEUE_WITH_BET, BlackjackJoinQueueWithBetMessageComposer);

        //CUSTOM FURNIFIX / 1 CLICK
        this._composers.set(OutgoingHeader.CLICK_FURNI, ClickFurniMessageComposer);
        this._composers.set(OutgoingHeader.INSPECT_FURNI_VARIABLES, InspectFurniVariablesComposer);
        this._composers.set(OutgoingHeader.IS_ON_FURNIFIXTOOL, IsOnFurniFixMessageComposer);
        this._composers.set(OutgoingHeader.FURNIFIXTOOL_SAVE, FurniFixToolSaveMessageComposer);
        this._composers.set(OutgoingHeader.FURNIFIXTOOL_BATCH_SAVE, FurniFixToolBatchSaveMessageComposer);
        // Room variable system
        this._composers.set(OutgoingHeader.REQUEST_ROOM_VARIABLES, RequestRoomVariablesComposer);
        this._composers.set(OutgoingHeader.REQUEST_USER_VARIABLES, RequestUserVariablesComposer);
        this._composers.set(OutgoingHeader.REQUEST_FURNI_WITH_VARIABLES, RequestFurniWithVariablesComposer);
        ...
        this._composers.set(OutgoingHeader.TOGGLE_USER_INSPECTION_LOCK, ToggleUserInspectionLockComposer);
        this._composers.set(OutgoingHeader.TOGGLE_GLOBAL_INSPECTION, ToggleGlobalInspectionComposer);
        ...
        // FRAMES
        this._composers.set(OutgoingHeader.GET_AVATAR_FRAMES, GetAvatarFramesComposer);
        this._composers.set(OutgoingHeader.SET_ACTIVATED_FRAME, SetActivatedFrameComposer);
        ...
        this._composers.set(OutgoingHeader.ROOM_SETTINGS_SAVE_WIRED, SaveWiredSettingsComposer);
        ...
        this._composers.set(OutgoingHeader.WIRED_CLIPBOARD_COPY, CopyWiredConfigMessageComposer);
        this._composers.set(OutgoingHeader.WIRED_CLIPBOARD_PASTE, PasteWiredConfigMessageComposer);
        this._composers.set(OutgoingHeader.WIRED_CLIPBOARD_TOGGLE_AUTOPASTE, SetWiredClipboardAutopasteMessageComposer);
        ...
        this._composers.set(OutgoingHeader.USER_SETTINGS_ROTATIONS, UserSettingsOldRotationsComposer);
        this._composers.set(OutgoingHeader.USER_SETTINGS_INVITES, UserSettingsRoomInvitesComposer);
        this._composers.set(OutgoingHeader.USER_SETTINGS_WIRED_ANIMATIONS, UserSettingsWiredAnimationsComposer);
        this._composers.set(OutgoingHeader.USER_SETTINGS_MOUSE_WHEEL_ZOOM, UserSettingsMouseWheelZoomComposer);
