...
import { BulkSlideUsersItemsEvent, CopyWiredConfigMessageComposer, PasteWiredConfigMessageComposer, RoomUnitStatusCustomEvent, SetWiredClipboardAutopasteMessageComposer, WiredClipboardStatusMessageEvent } from './messages';
...
export class NitroMessages implements IMessageConfiguration {
    ...
    private registerEvents(): void {
        ...
        this._events.set(IncomingHeader.BULK_SLIDE_ITEMS_USERS, BulkSlideUsersItemsEvent);
        ...
        this._events.set(IncomingHeader.UNIT_STATUS_CUSTOM, RoomUnitStatusCustomEvent);
