export class WiredConditionlayout
{
    ...
    public static ACTIVATOR_MATCH: number = 26;
    public static SELECT_QUANTITY: number = 27;
    public static HEIGHT: number = 28;
    public static HAS_VARIABLE: number = 29;
    public static HAS_VAR: number = 30;
