...
import { FurniFixToolView } from './views/furnifixtool/FurniFixToolView';
...
export const ModToolsView: FC<{}> = props =>
{
    ...
    const [ isFurniFixToolVisible, setIsFurniFixToolVisible ] = useState(false);
    ...
    return (
        <>
            { isVisible &&
                <NitroCardView style={{width:"200px",height:"200px"}} uniqueKey="mod-tools" className="nitro-mod-tools" windowPosition={ DraggableWindowPosition.TOP_LEFT } theme="primary-slim" >
                    ...
                    <NitroCardContentView className="text-black" gap={ 1 }>
                        ...
                        <Button gap={ 1 } onClick={ () => setIsFurniFixToolVisible(prevValue => !prevValue) } className="position-relative">
                            <Base className="icon icon-tickets position-absolute start-1"/> FurniFix Tool
                        </Button>
            ...
            { isFurniFixToolVisible && <FurniFixToolView onCloseClick={ () => setIsFurniFixToolVisible(false)  } />} 
        </>
    );
}
