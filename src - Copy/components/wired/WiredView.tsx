import { ConditionDefinition, TriggerDefinition, WiredActionDefinition, WiredAddonDefinition, WiredSelectorDefinition } from '@nitrots/nitro-renderer';
...
export const WiredView: FC<{}> = props =>
{
  ...
  {
    return WiredActionLayoutView(trigger.code);
  }
  ...
  {
    return WiredSelectorLayoutView(trigger.code);
  }

  if (trigger instanceof WiredAddonDefinition)
  {
    return WiredAddonLayoutView(trigger.code);
  }
