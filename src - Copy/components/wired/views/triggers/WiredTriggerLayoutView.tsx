...
import { WiredTriggerAvatarByActionView } from './WiredTriggerAvatarByActionView';
...
import { WiredTriggerClickOnAvatarView } from './WiredTriggerClickOnAvatarView';
...
import { WiredTriggerKeyboardActionView } from './WiredTriggerKeyboardActionView';
import { WiredTriggeScoreAchievedView } from './WiredTriggerScoreAchievedView';
import { WiredTriggerStateModifiedView } from './WiredTriggerStateModifiedView';
import { WiredTriggerToggleFurniView } from './WiredTriggerToggleFurniView';
import { WiredTriggerVariableEventView } from './WiredTriggerVariableEventView';
...
export const WiredTriggerLayoutView = (code: number) =>
{
    switch (code)
    {
        ...
        case WiredTriggerLayout.STATE_MODIFIED:
            return <WiredTriggerStateModifiedView />;
        case WiredTriggerLayout.BY_ACTION:
            return <WiredTriggerAvatarByActionView />;
        case WiredTriggerLayout.AVATAR_CLICKED:
            return <WiredTriggerClickOnAvatarView />;
            case WiredTriggerLayout.COMMAND_EXEC:
            return <WiredTriggerCommandExecView />;
            case WiredTriggerLayout.KEYBOARD_INPUT:
