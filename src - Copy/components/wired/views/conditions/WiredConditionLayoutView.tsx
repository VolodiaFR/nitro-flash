...
import { WiredConditionActivatorMatch } from './WiredConditionActivatorMatch';
...
import { WiredConditionHeightView } from './WiredConditionHeightView';
import { WiredConditionHasVariableView } from './WiredConditionHasVariableView';
import { WiredConditionHasVarView, WiredConditionNegHasVarView } from './WiredConditionHasVarView';
import { WiredConditionSelectQuantity } from './WiredConditionSelectQuantityView';
...
export const WiredConditionLayoutView = (code: number) =>
{
    switch (code)
    {
        ...
        case WiredConditionlayout.ACTIVATOR_MATCH:
            return <WiredConditionActivatorMatch />;
        case WiredConditionlayout.SELECT_QUANTITY:
            return <WiredConditionSelectQuantity />;
            case WiredConditionlayout.HEIGHT:
            return <WiredConditionHeightView />;
            case WiredConditionlayout.HAS_VARIABLE:
                return <WiredConditionHasVariableView />;
            case WiredConditionlayout.HAS_VAR:
                return <WiredConditionHasVarView />;
            case WiredConditionlayout.NEG_HAS_VAR:
                return <WiredConditionNegHasVarView />;
            case WiredConditionlayout.VAR_VALUE_MATCH:
