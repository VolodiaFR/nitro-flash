...
export const WiredAddonFilterFurniByVarView: FC = () => {
        ...
        <WiredAddonBaseView hasSpecialInput={true} save={save} requiresFurni={0}>
            <Column gap={1}>
                ...
                <Flex gap={1} alignItems='center'>
                    <input type='radio' name='cm' checked={countMode === 0} onChange={() => setCountMode(0)} />
                    <Text>Definir valor</Text>
                    <input type='number' value={fixedCount} onChange={e => setFixedCount(parseInt(e.target.value) || 0)} />
                </Flex>
                <Flex gap={1} alignItems='center'>
                    <input type='radio' name='cm' checked={countMode === 1} onChange={() => setCountMode(1)} />
