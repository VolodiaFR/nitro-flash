...
export const AvatarInfoWidgetView: FC<{}> = props =>
{
    ...
    const { avatarInfo = null, setAvatarInfo = null, activeNameBubble = null, setActiveNameBubble = null, nameBubbles = [], variableBubbles = [], removeNameBubble = null, productBubbles = [], confirmingProduct = null, updateConfirmingProduct = null, removeProductBubble = null, isDecorating = false, setIsDecorating = null, blackjackSessions, removeBlackjackSession, showBetDialog, betSessionId, handleBet, cancelBet } = useAvatarInfoWidget();
    ...
    useEffect(() =>
    {
        if(showBetDialog)
        {
            const id = setTimeout(() => cancelBet(), 10000);
            setTimeoutId(id);
        }
        else
        {
