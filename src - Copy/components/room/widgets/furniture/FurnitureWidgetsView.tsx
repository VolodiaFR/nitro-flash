...
import { FurnitureStackHeightHandler } from './FurnitureStackHeightHandler';
...
import { FurnitureVariableDisplayView } from './FurnitureVariableDisplayView';
