...
export class RoomObjectSprite implements IRoomObjectSprite
{
    ...
    private _skipMouseHandling: boolean;
    ...
    {
        if(this._clickHandling === flag) return;
    ...
    public set skipMouseHandling(value: boolean)
    {
        if(this._skipMouseHandling === value) return;
