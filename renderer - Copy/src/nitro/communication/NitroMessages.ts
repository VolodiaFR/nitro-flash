...
import { BulkSlideItemsEvent } from './messages/incoming/room/engine/BulkSlideItemsEvent';
...
export class NitroMessages implements IMessageConfiguration {
    ...
    private registerEvents(): void {
        ...
        this._events.set(IncomingHeader.BULK_SLIDE_ITEMS, BulkSlideItemsEvent);
        this._events.set(IncomingHeader.BULK_SLIDE_USERS_AND_ITEMS, BulkSlideUsersAndItemsEvent);
