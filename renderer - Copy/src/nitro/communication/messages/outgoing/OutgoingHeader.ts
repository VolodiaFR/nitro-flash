export class OutgoingHeader
{
    ...
    // CUSTOM
    public static KEYBOARD_INPUT = 6028;
    public static WIRED_SELECTOR_SAVE = 6027;
    public static WIRED_ADDON_SAVE = 6008;
    public static REQUEST_ROOM_VARIABLES = 6029;
    public static REQUEST_FURNI_WITH_VARIABLES = 6030;
    public static REQUEST_USER_WITH_VARIABLES = 6037;
    public static REQUEST_USER_VARIABLES = 6036;
    public static REQUEST_GLOBAL_VARIABLES = 6038;
    public static REQUEST_GLOBAL_WITH_VARIABLES = 6039;
    public static TOGGLE_HIGHLIGHT_MODE = 6031;
    public static TOGGLE_FURNI_INSPECTION_LOCK = 6040;
    public static INSPECT_USER_VARIABLES = 6041;
    ...
    public static REQUEST_CONTEXT_VARIABLES = 6052;
    ...
    public static IS_ON_FURNIFIXTOOL = 6003;
    public static FURNIFIXTOOL_SAVE = 6004;
    public static FURNIFIXTOOL_BATCH_SAVE = 6005;
    ...
    public static ROOM_SETTINGS_SAVE_WIRED = 1970;
    ...
    public static USER_SETTINGS_MOUSE_WHEEL_ZOOM = 6500;
    ...
    public static WIRED_APPLY_SNAPSHOT = 6046;
