...
export interface IContextVariableData {
    name: string;
    availability: string;
    hasValue: boolean;
    canWriteTo: boolean;
...
export class RoomContextVariablesMessageParser {
    private _vars: IContextVariableData[] = [];
    ...
    public get vars(): IContextVariableData[] {
        return this._vars;
    }
}
