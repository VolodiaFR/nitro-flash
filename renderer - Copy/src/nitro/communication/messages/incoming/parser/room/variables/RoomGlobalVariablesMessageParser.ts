...
export interface IGlobalUserVariableData {
    name: string;
    availability: string;
    hasValue: boolean;
    canWriteTo: boolean;
...
export class RoomGlobalVariablesMessageParser {
    private _vars: IGlobalUserVariableData[] = [];
    ...
    public get vars(): IGlobalUserVariableData[] { return this._vars; }
}