...
export interface IInternalUserVariableData {
    name: string;
    availability: string;
    hasValue: boolean;
    canWriteTo: boolean;
...
export class RoomInternalUserVariablesMessageParser {
    private _vars: IInternalUserVariableData[] = [];
    ...
    public get vars(): IInternalUserVariableData[] { return this._vars; }
}
