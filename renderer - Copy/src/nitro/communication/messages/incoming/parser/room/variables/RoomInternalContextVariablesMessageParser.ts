...
export interface IInternalContextVariableData {
    name: string;
    availability: string;
    hasValue: boolean;
    canWriteTo: boolean;
...
export class RoomInternalContextVariablesMessageParser {
    private _vars: IInternalContextVariableData[] = [];
    ...
    public get vars(): IInternalContextVariableData[] {
        return this._vars;
    }
}
