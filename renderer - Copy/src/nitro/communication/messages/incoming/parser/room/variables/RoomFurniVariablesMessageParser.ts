...
export interface IVariableTextEntry {
    index: number;
    text: string;
}

export interface IFurniUserVariableData {
    name: string;
    availability: string;
    hasValue: boolean;
    canWriteTo: boolean;
...
export class RoomFurniVariablesMessageParser {
    private _vars: IFurniUserVariableData[] = [];
    ...
    public get vars(): IFurniUserVariableData[] { return this._vars; }
}
