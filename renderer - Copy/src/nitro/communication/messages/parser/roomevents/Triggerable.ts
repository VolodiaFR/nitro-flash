...
export class Triggerable
{
    ...
    // do not parse destination list here; that's action-specific and parsed by WiredActionDefinition
    private _id: number;
    ...
    constructor(wrapper: IMessageDataWrapper)
    {
        ...
        // For compatibility, do not read any destination block here; it's action-specific
    ...
    // Destination-specific list is parsed by WiredActionDefinition for action dialogs
