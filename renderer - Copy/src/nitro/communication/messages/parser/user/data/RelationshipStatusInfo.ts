...
export class RelationshipStatusInfo
{
    ...
    private _randomFriendIsVip: boolean;
    ...
    this._randomFriendIsVip = wrapper.readBoolean();
    ...
    public get randomFriendIsVip(): boolean
    {
        return this._randomFriendIsVip;
    }
}
