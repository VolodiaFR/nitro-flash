...
export class RoomInstanceData
{
    ...
    private _userFocusAlpha: Map<number, number>;
    ...
    public setUserFocusAlpha(objectId: number, value: number): void
    {
        this._userFocusAlpha.set(objectId, value);
    }

    public getUserFocusAlpha(objectId: number): number | null
    {
        const existing = this._userFocusAlpha.get(objectId);
    ...
    public clearUserFocusAlpha(objectId: number): void
    {
        this._userFocusAlpha.delete(objectId);
    }

    public clearAllUserFocusAlpha(): void
    {
        this._userFocusAlpha.clear();
    }
